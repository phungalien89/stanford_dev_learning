<aside class="app-sidebar">
    <div class="" class="app-sidebar__user">
      <img class="app-sidebar__user-avatar" src="{{ asset('img/user1.jpg') }}" alt="User Image">
      <p class="app-sidebar__user-name">Anderson NP</p>
